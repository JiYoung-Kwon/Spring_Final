...
<div id = "hobby_Board">
		...
		<h1 id="hobby_header">이시국 취미생활</h1>
		
		<div id ="hobby_menubtn_zone">
 		<input type='button' class='btn_issue' id='btn_issue'  value="위험지역 이슈"  onclick="tab('issue')"/>
 		<input type='button' class='btn_news' id='btn_news'  value="코로나 관련 보도"  onclick="tab('news')"/>
 		<input type='button' class='btn_hobby' id='btn_hobby'   value="이시국 취미생활" onclick="tab('hobby')"/>
		</div>
		...
		<form id="hobby_frm" name="hobby_frm" method="post" action="">
