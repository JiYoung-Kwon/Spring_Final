...
<div id = "hobby_Board">
		...
		<div id ="hobby_menubtn_zone">
 		<input type='button' class='btn_issue' id='btn_issue'  value="위험지역 이슈"  onclick="tab('issue_M')"/>
 		<input type='button' class='btn_news' id='btn_news'  value="코로나 관련 보도"  onclick="tab('news_M')"/>
