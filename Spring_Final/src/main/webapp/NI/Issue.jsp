...
<div id = "Issue_Board">
		...
		<div id ="Issue_menubtn_zone">
 		...
 		<input type='button' class='btn_news' id='btn_news' name='btn_issue' value="코로나 관련 보도"  onclick="tab('news')"/>
 		<input type='button' class='btn_hobby' id='btn_hobby' name='btn_issue' value="이시국 취미생활"  onclick="tab('hobby')"/>
		</div>
