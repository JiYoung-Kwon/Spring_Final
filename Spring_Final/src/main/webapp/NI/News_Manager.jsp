...
<div id = "News_Board">
		...
		<div id ="News_menubtn_zone">
 		...
 		<input type='button' class='btn_news' id='btn_news' name='btn_news' value="코로나 관련 보도" onclick="tab('news_M')"/>
 		<input type='button' class='btn_hobby' id='btn_hobby' name='btn_hobby' value="이시국 취미생활" onclick="tab('hobby_M')" />
		</div>
		
		<form id="News_board_frm" name="News_frm" method="post" onsubmit="return false">
			...
			<div id="News_searchbox">
				<input id="findStr" name='News_findbtn' type="text"  value="${page.findStr }" onkeyup="EnterAction(event)">
