	...
	<div id='sang'>
		<form name='frm_sang' id='frm_sang' class='frm_sang' method='post'
			...
			<div id='find'>
			  ...
			  <option value="sanghwal_basic" <c:if test="${param.gubun eq 'sanghwal_basic'}">selected = "selected"</c:if>>제목</option>
			  <option value="sanghwal_doc" <c:if test="${param.gubun eq 'sanghwal_doc'}">selected = "selected"</c:if>>내용</option>
		      </select>
