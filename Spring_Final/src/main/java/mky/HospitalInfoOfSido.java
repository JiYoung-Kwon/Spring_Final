...
public class HospitalInfoOfSido {
	
	public void sidoAddress(HospitalVo vo) {
...
//		DocumentBuilderFactory 생성
        ...
        urlBuilder.append("&" + URLEncoder.encode("sidoCd","UTF-8") + "=" + URLEncoder.encode(vo.getSidoCd()+"0000", "UTF-8")); /*시도코드명(UTF-8 인코딩 필요)*/
